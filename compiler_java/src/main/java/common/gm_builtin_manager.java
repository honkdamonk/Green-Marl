...
public class gm_builtin_manager {
	...
	private static final gm_builtin_desc_t[] GM_builtins = { //
			...
			new gm_builtin_desc_t("*Push", gm_method_id_t.GM_BLTIN_SET_ADD_BACK, AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_GROW)),
			...
			new gm_builtin_desc_t("*Pop", gm_method_id_t.GM_BLTIN_SET_REMOVE, AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK)),
