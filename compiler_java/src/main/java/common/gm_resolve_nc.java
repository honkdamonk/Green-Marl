...
public class gm_resolve_nc {
	...
	// //--------------------------------------------------------------------------------
	// bool gm_resolve_name_conflict(ast_sent *s, gm_symtab_entry *e, bool
	// is_scalar);
	//
	...
	//
	// public:
	// bool replace_conflicting_symtab_entries(ast_sent* s, gm_symtab_entry *e,
	// bool is_for_scalar)
	// {
	// _found = false;
	// //_top = s;
	...
	// //------------------------------------------------------------------------------------
	// // For the subtree top,
	// // Reflect the name in the symbol-table e (which has been modifid), to
	// all id nodes
	// //------------------------------------------------------------------------------------
	// //bool gm_reflect_symbol_entry_name(gm_symtab_entry *e_modified,
	// ast_node* top);
	...
	// bool _changed;
	// };
	// bool gm_reflect_symbol_entry_name(gm_symtab_entry *e_modified, ast_node*
	// top)
	// {
