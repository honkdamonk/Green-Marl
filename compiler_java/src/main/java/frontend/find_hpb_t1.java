...
public class find_hpb_t1 extends gm_apply {
	...
	/** map of symbol & depth */
	private final Map<gm_symtab_entry, Integer> depth_map = new HashMap<gm_symtab_entry, Integer>();

	/** map of iterator symbol & is parallel */
	private final Map<gm_symtab_entry, Boolean> para_iter_map = new HashMap<gm_symtab_entry, Boolean>();
