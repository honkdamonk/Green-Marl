 ...
 */
public abstract class AbstractGMLexer
    extends Lexer

{
     ...
     */
    public AbstractGMLexer(CharStream input) {
     ...
     */
    public AbstractGMLexer(CharStream input, RecognizerSharedState state) {
        super(input,state);
    }
