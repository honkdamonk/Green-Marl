...
public class find_hpb_t extends gm_apply
{
	...
	public boolean apply(ast_sent s)
	{
		...
		else
		{
			...
			{
				if (para_iter_map.get(a.get_bound().getSymInfo())) // is parallel
				{
	...
	private java.util.HashMap<gm_symtab_entry, Integer> depth_map = new java.util.HashMap<gm_symtab_entry, Integer>(); // map of symbol & depth
	private java.util.HashMap<gm_symtab_entry, Boolean> para_iter_map = new java.util.HashMap<gm_symtab_entry, Boolean>(); // map of iterator symbol & is parallel
}