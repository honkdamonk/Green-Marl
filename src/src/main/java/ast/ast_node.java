...
//	friend class gm_apply;
	...
	{
		return (nodetype == AST_NODE_TYPE.AST_SENTBLOCK) || (nodetype == AST_NODE_TYPE.AST_FOREACH) || (nodetype == AST_NODE_TYPE.AST_PROCDEF) || (nodetype == AST_NODE_TYPE.AST_EXPR_RDC) || (nodetype == AST_NODE_TYPE.AST_BFS);
	}
	...
	public void add_info_map_key_value(String id, Object k, Object v)
	{
		...
		java.util.HashMap<Object, Object > S = ((ast_extra_info_map) find_info(id)).get_map();
		S.put(k, v);
	}
	...
	public java.util.HashMap<Object, Object > get_info_map(String id)
	{
	...
	protected int line;
	protected int col;
	protected java.util.HashMap<String, ast_extra_info> extra = new java.util.HashMap<String, ast_extra_info>();
}