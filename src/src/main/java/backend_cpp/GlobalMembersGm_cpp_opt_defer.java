...
public class GlobalMembersGm_cpp_opt_defer {
	...
	public static void add_conditional_initialize(ast_sent seq_loop, ast_foreach target_fe, ast_foreach init, gm_symtab_entry target_old,
			gm_symtab_entry target_new) {

		GlobalMembersGm_transform_helper.gm_make_it_belong_to_sentblock(seq_loop); // make
																					// sure
																					// fe
																					// belongs
																					// to
	...
	public static boolean check_if_modified_elsewhere(gm_symtab_entry e, ast_sent myself, ast_sent seq_loop) {
		...
		return GlobalMembersGm_cpp_opt_defer.check_if_modified_elsewhere(e, up, seq_loop); // move
																							// up
																							// one-level
