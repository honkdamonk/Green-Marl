...
public class GlobalMembersGm_gps_new_check_random_write {
	...
	// (to => assign_sttement, what: the sentblock that contains random write
	// for this assign statement)
	// FLAG_RANDWM_WRITE_SYMBOL_FOR_SB
	// (to => sent_block, what: set of symbols that are used as ramdom-write
	// driver in the sent-block)
	// -----------------------------------------------------------------
