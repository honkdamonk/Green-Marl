...
public class check_usage_t extends gps_apply_bb_ast
{
	public check_usage_t()
	{
		set_is_pre(true);
		_okay_to_merge = true;
		set_state(GlobalMembersGm_gps_bb_merge_again.FOR_PAR1);
	}
	...
	{
		_state = s;
		if (_state == GlobalMembersGm_gps_bb_merge_again.FOR_PAR1)
		{
			set_for_sent(true);
			set_for_expr(false);
		}
	...
	public boolean apply(ast_sent s)
	{
		switch (_state)
		{
			case GlobalMembersGm_gps_bb_merge_again.FOR_PAR1:
				apply_par1(s);
				break;
			case GlobalMembersGm_gps_bb_merge_again.FOR_SEQ1:
				apply_seq1(s);
				break;
			case GlobalMembersGm_gps_bb_merge_again.FOR_PAR2:
				apply_par2(s);
				break;
		}
		return true;
