...
public class gm_gps_beinfo extends gm_backend_info
{
	...
	public final java.util.LinkedList<gm_gps_basic_block> get_basic_blocks()
	{
		return bb_blocks;
	}
	...
	//-------------------------------------------------------------------
	public final java.util.HashSet<gm_gps_comm_unit, gm_gps_comm_unit> get_communication_loops()
	{
		return comm_loops;
	}
...
//ORIGINAL LINE: if (comm_loops.find(C) != comm_loops.end())
		if (comm_loops.find(new gm_gps_comm_unit(C)).hasNext()) //  already added
			return;

		comm_loops.add(C);

		java.util.LinkedList<gm_gps_communication_symbol_info> new_list = new java.util.LinkedList<gm_gps_communication_symbol_info>();
	...
	public final java.util.LinkedList<gm_gps_communication_symbol_info> get_all_communication_symbols_nested(ast_foreach fe, int comm_type)
	{
		gm_gps_comm_unit U = new gm_gps_comm_unit(gm_gps_comm_t.GPS_COMM_NESTED, fe);
	...
	public final java.util.LinkedList<gm_gps_communication_symbol_info> get_all_communication_symbols(gm_gps_comm_unit U)
	...
	public final java.util.LinkedList<ast_sent> get_random_write_sents(gm_gps_comm_unit U)
	{
		return random_write_sents.get(U);
	}

	public final java.util.LinkedList<ast_sent> get_random_write_sents(ast_sentblock sb, gm_symtab_entry sym)
	{
	...
	{
		java.util.LinkedList<ast_sent> L = random_write_sents.get(U);
		L.addLast(s);
	}
...
///#define UPDATE_A_IF_SMALLER(A,B) if ((A)<(B)) {A = B; }
	...
	public final java.util.HashSet<gm_symtab_entry> get_scalar_symbols()
	{
		return scalar;
	}
	public final java.util.HashSet<gm_symtab_entry> get_node_prop_symbols()
	{
		return node_prop;
	}
	public final java.util.HashSet<gm_symtab_entry> get_edge_prop_symbols()
	{
		return edge_prop;
	}
	...
	public final java.util.LinkedList<gm_gps_congruent_msg_class> get_congruent_message_classes()
	{
	...
	private gm_gps_basic_block bb_entry; // entry for the procedure basic blocks (DAG)
	private java.util.LinkedList<gm_gps_basic_block> bb_blocks = new java.util.LinkedList<gm_gps_basic_block>(); // same as above DAG, but flattened as list
												// (created by gm_gps_bb_find_reachable.cc)

	private java.util.HashSet<gm_symtab_entry> scalar = new java.util.HashSet<gm_symtab_entry>(); // list of persistent master symbols
	private java.util.HashSet<gm_symtab_entry> node_prop = new java.util.HashSet<gm_symtab_entry>(); // list of persistent property symbols
	private java.util.HashSet<gm_symtab_entry> edge_prop = new java.util.HashSet<gm_symtab_entry>(); // list of persistent property symbols
	...
	private java.util.HashMap<gm_gps_comm_unit, java.util.LinkedList<gm_gps_communication_symbol_info>, gm_gps_comm_unit> comm_symbol_info = new java.util.HashMap<gm_gps_comm_unit, java.util.LinkedList<gm_gps_communication_symbol_info>, gm_gps_comm_unit>();
	private java.util.HashMap<gm_gps_comm_unit, gm_gps_communication_size_info, gm_gps_comm_unit> comm_size_info = new java.util.HashMap<gm_gps_comm_unit, gm_gps_communication_size_info, gm_gps_comm_unit>();
	private gm_gps_communication_size_info max_comm_size = new gm_gps_communication_size_info();

	// set of communications
	private java.util.HashSet<gm_gps_comm_unit, gm_gps_comm_unit> comm_loops = new java.util.HashSet<gm_gps_comm_unit, gm_gps_comm_unit>();

	private java.util.HashMap<gm_gps_comm_unit, java.util.LinkedList<ast_sent>, gm_gps_comm_unit> random_write_sents = new java.util.HashMap<gm_gps_comm_unit, java.util.LinkedList<ast_sent>, gm_gps_comm_unit>();

	// congruent message class information
	private java.util.LinkedList<gm_gps_congruent_msg_class> congruent_msg = new java.util.LinkedList<gm_gps_congruent_msg_class>();
