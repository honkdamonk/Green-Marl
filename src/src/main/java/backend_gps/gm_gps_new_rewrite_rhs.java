...
public class gm_gps_new_rewrite_rhs extends gm_compile_step
{
	...
	public void process(ast_procdef proc)
	{
		...
		GlobalMembersGm_transform_helper.gm_reconstruct_scope(proc); // TODO--> get rid of 'parent' pointer of symtabs. (It is hard to move sentences around with this)
		...
		// now re-do analysis
		GlobalMembersGm_gps_new_analysis_scope_sent_var.gm_gps_do_new_analysis_scope_sent_var(proc);
