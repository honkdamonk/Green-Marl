...
public class GlobalMembersGm_new_typecheck_step1 {
	...
	// ORIGINAL LINE: static boolean gm_find_and_connect_symbol(ast_id* id,
	// gm_symtab* begin, boolean print_error = true)
	...
	// add a (copy of) symbol and (copy of) type into a symtab, error if symbol
	// is duplicated
