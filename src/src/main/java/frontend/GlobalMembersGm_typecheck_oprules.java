...
public class GlobalMembersGm_typecheck_oprules {
	...
	public static void init_op_rules() {
		{
			gm_type_rule R = new gm_type_rule(gm_operator_t.INT_OP, gm_operator_type_class_t.T_INT, gm_operator_type_class_t.T_INT,
					gm_operator_result_t.RESULT_COERCION, gm_operator_coercion_t.COERCION_ALL);
			GM_TYPE_RULES.add(R);
		}
		;
		{
		...
		;
		{
			gm_type_rule R = new gm_type_rule(gm_operator_t.BOOL_OP, gm_operator_type_class_t.T_BOOL, gm_operator_type_class_t.T_BOOL,
					gm_operator_result_t.RESULT_BOOL, gm_operator_coercion_t.COERCION_NO);
			GM_TYPE_RULES.add(R);
		}
		;
		{
			gm_type_rule R = new gm_type_rule(gm_operator_t.COMP_OP, gm_operator_type_class_t.T_NUMERIC_INF, gm_operator_type_class_t.T_NUMERIC_INF,
					gm_operator_result_t.RESULT_BOOL, gm_operator_coercion_t.COERCION_ALL);
			GM_TYPE_RULES.add(R);
		}
		;
		{
		...
		{
			gm_type_rule R = new gm_type_rule(gm_operator_t.TER_OP, gm_operator_type_class_t.T_COMPATIBLE, gm_operator_type_class_t.T_COMPATIBLE,
					gm_operator_result_t.RESULT_LEFT, gm_operator_coercion_t.COERCION_NO);
			GM_TYPE_RULES.add(R);
		}
		;
		{
			gm_type_rule R = new gm_type_rule(gm_operator_t.TER_OP, gm_operator_type_class_t.T_NUMERIC_INF, gm_operator_type_class_t.T_NUMERIC_INF,
					gm_operator_result_t.RESULT_LEFT, gm_operator_coercion_t.COERCION_ALL);
			GM_TYPE_RULES.add(R);
		}
		;

		{
			gm_type_rule R = new gm_type_rule(gm_operator_t.ASSIGN_OP, gm_operator_type_class_t.T_NUMERIC_INF, gm_operator_type_class_t.T_NUMERIC_INF,
					gm_operator_result_t.RESULT_LEFT, gm_operator_coercion_t.COERCION_RIGHT);
			GM_TYPE_RULES.add(R);
		}
		;
		{
	...
	public static void apply_coercion(int c_type, int t1, int t2, tangible.RefObject<Integer> t1_new, tangible.RefObject<Integer> t2_new,
			tangible.RefObject<Boolean> t1_warn, tangible.RefObject<Boolean> t2_warn) {
		t1_new.argvalue = t1;
		t2_new.argvalue = t2;
	...
	public static boolean gm_is_compatible_type(GM_OPS_T op, GMTYPE_T t1, GMTYPE_T t2, tangible.RefObject<Integer> op_result_type,
			tangible.RefObject<Integer> t1_new, tangible.RefObject<Integer> t2_new, tangible.RefObject<Boolean> t1_warn, tangible.RefObject<Boolean> t2_warn) {
		// special case
		...
		if ((GlobalMembersGm_defs.gm_is_set_collection_type(t1) && GlobalMembersGm_defs.gm_is_collection_of_set_iter_type(t2))
				|| (GlobalMembersGm_defs.gm_is_sequence_collection_type(t1) && GlobalMembersGm_defs.gm_is_collection_of_seq_iter_type(t2))
				|| (GlobalMembersGm_defs.gm_is_order_collection_type(t1) && GlobalMembersGm_defs.gm_is_collection_of_order_iter_type(t2)))
			t2 = t1;
