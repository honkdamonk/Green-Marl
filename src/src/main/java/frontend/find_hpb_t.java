...
public class find_hpb_t extends gm_apply
{
	...
	public final gm_symtab_entry find_closest_any_boundary_iterator() // can be a sequence
	{
		java.util.LinkedList<find_bound_t>.reverse_iterator I = new java.util.LinkedList<find_bound_t>.reverse_iterator();
	...
	public final gm_symtab_entry find_highest_parallel_boundary_iterator(gm_symtab_entry entry, boolean is_prop)
	{
		...
		java.util.Iterator<find_bound_t> I;
		for (I = scope.iterator(); I.hasNext();)
		{
			if (!def_found)
			{
