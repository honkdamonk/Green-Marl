...
//ORIGINAL LINE: sbyte* voca_temp_name(String base, gm_vocabulary* extra1 = null, boolean try_org_name_first = false)
...
//C++ TO JAVA CONVERTER NOTE: Java does not allow default values for parameters. Overloaded methods are inserted above.
//ORIGINAL LINE: sbyte* voca_temp_name_and_add(String base, String suffix, gm_vocabulary* extra1 = null, boolean insert_underscore_prefix_if_not_already = false)
...
//C++ TO JAVA CONVERTER NOTE: Java does not allow default values for parameters. Overloaded methods are inserted above.
//ORIGINAL LINE: sbyte* voca_temp_name_and_add(String base, gm_vocabulary* extra1 = null, boolean try_org_name_first = false)
...
//ORIGINAL LINE: sbyte* c = proc_info[_curr_proc]->generate_temp_name(base, extra1, try_org_name_first);
...
//ORIGINAL LINE: java.util.LinkedList<gm_compile_step*>& LIST = this->local_steps;
		java.util.LinkedList<gm_compile_step> LIST = new java.util.LinkedList(this.local_steps);
