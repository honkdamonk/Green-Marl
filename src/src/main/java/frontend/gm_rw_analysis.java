...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: java.util.HashMap<gm_symtab_entry*, java.util.LinkedList<gm_rwinfo*>*>& M = sets->mutate_set;
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> M = new java.util.HashMap(sets.mutate_set);
...
//ORIGINAL LINE: java.util.HashMap<gm_symtab_entry*, java.util.LinkedList<gm_rwinfo*>*>& M = sets->mutate_set;
		...
		java.util.LinkedList<ast_sent> sents = s.get_sents();
...
//ORIGINAL LINE: java.util.HashMap<gm_symtab_entry*, java.util.LinkedList<gm_rwinfo*>*>& M = sets->mutate_set;
		...
		// make temporary copy
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> R_temp = new java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>>();
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> W_temp = new java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>>();
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> D_temp = new java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>>();
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> M_temp = new java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>>();
		...
		boolean is_conditional = (a.get_filter() != null) || (GlobalMembersGm_defs.gm_is_collection_iter_type(a.get_iter_type()));
		...
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> B = GlobalMembersGm_rw_analysis.gm_get_bound_set_info(a).bound_set;
...
//ORIGINAL LINE: java.util.HashMap<gm_symtab_entry*, java.util.LinkedList<gm_rwinfo*>*>& M = sets->mutate_set;
		...
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> R_temp = new java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>>();
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> W_temp = new java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>>();
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> D_temp1 = new java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>>();
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> D_temp2 = new java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>>();
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> M_temp = new java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>>();
		...
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> B = GlobalMembersGm_rw_analysis.gm_get_bound_set_info(a).bound_set;
		java.util.HashMap<gm_symtab_entry, java.util.LinkedList<gm_rwinfo>> B2 = GlobalMembersGm_rw_analysis.gm_get_bound_set_info(a).bound_set_back;
