...
public class gm_rwinfo_query
{
	public gm_rwinfo_query()
	{
		...
		this.range = gm_range_type_t.GM_RANGE_INVALID.getValue();
		this.reduce_op = GM_REDUCE_T.GMREDUCE_NULL.getValue();
		this.driver = null;
		this.bound = null;
		this.always = true;
	}
	public final void check_range(int r)
	{
	...
	public final void check_reduce_op(int o)
	{
