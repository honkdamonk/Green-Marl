...
public class GlobalMembersGm_defs
{
	...
	{
		return (i == GMTYPE_T.GMTYPE_NODEITER_ALL) || (i == GMTYPE_T.GMTYPE_NODEITER_BFS); // [XXX] to be finxed
	}
	...
	{
		return (i == GMTYPE_T.GMTYPE_NODEITER_NBRS) || (i == GMTYPE_T.GMTYPE_NODEITER_IN_NBRS) || (i == GMTYPE_T.GMTYPE_NODEITER_UP_NBRS) || (i == GMTYPE_T.GMTYPE_NODEITER_DOWN_NBRS) || (i == GMTYPE_T.GMTYPE_NODEITER_COMMON_NBRS);
	}

	public static boolean gm_is_any_nbr_edge_iter_type(GMTYPE_T i)
	{
		return (i == GMTYPE_T.GMTYPE_EDGEITER_NBRS) || (i == GMTYPE_T.GMTYPE_EDGEITER_IN_NBRS) || (i == GMTYPE_T.GMTYPE_EDGEITER_UP_NBRS) || (i == GMTYPE_T.GMTYPE_EDGEITER_DOWN_NBRS);
	}
	...
	{
		return (i == GMTYPE_T.GMTYPE_INF) || (i == GMTYPE_T.GMTYPE_INF_INT) || (i == GMTYPE_T.GMTYPE_INF_LONG) || (i == GMTYPE_T.GMTYPE_INF_FLOAT) || (i == GMTYPE_T.GMTYPE_INF_FLOAT);
	}
	...
	{
		return (i == GM_OPS_T.GMOP_MULT) || (i == GM_OPS_T.GMOP_DIV) || (i == GM_OPS_T.GMOP_MOD) || (i == GM_OPS_T.GMOP_ADD) || (i == GM_OPS_T.GMOP_SUB) || (i == GM_OPS_T.GMOP_NEG) || (i == GM_OPS_T.GMOP_ABS) || (i == GM_OPS_T.GMOP_MAX) || (i == GM_OPS_T.GMOP_MIN);
	}
	...
	public static boolean gm_is_compatible_type_for_assign(GMTYPE_T t_lhs, GMTYPE_T t_rhs, tangible.RefObject<Integer> t_new_rhs, tangible.RefObject<Boolean> warning)
	{
		int dummy1;
		int dummy2;
		boolean dummy_b;
	...
	{
		return (t == GM_REDUCE_T.GMREDUCE_PLUS) || (t == GM_REDUCE_T.GMREDUCE_MULT) || (t == GM_REDUCE_T.GMREDUCE_MIN) || (t == GM_REDUCE_T.GMREDUCE_MAX) || (t == GM_REDUCE_T.GMREDUCE_AND) || (t == GM_REDUCE_T.GMREDUCE_OR) || (t == GM_REDUCE_T.GMREDUCE_AVG);
	}
	public static boolean gm_is_numeric_reduce_op(GM_REDUCE_T t)
	{
		return (t == GM_REDUCE_T.GMREDUCE_PLUS) || (t == GM_REDUCE_T.GMREDUCE_MULT) || (t == GM_REDUCE_T.GMREDUCE_MIN) || (t == GM_REDUCE_T.GMREDUCE_MAX) || (t == GM_REDUCE_T.GMREDUCE_AVG);
	}
