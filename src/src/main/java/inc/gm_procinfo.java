...
//ORIGINAL LINE: sbyte* generate_temp_name(String base, gm_vocabulary* extra = null, boolean try_org_name_first = false)
	public final String generate_temp_name(String base, gm_vocabulary extra, boolean try_org_name_first)
	{
		...
		do
		{
			...
			boolean tempVar = flat.has_word(tempRef_temp);
			...
			{
				tangible.RefObject<String> tempRef_temp2 = new tangible.RefObject<String>(temp);
				boolean tempVar2 = (extra != null) && (extra.has_word(tempRef_temp2));
