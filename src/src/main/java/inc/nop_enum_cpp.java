...
public enum nop_enum_cpp
{
	...
	private static java.util.HashMap<Integer, nop_enum_cpp> mappings;
	private static java.util.HashMap<Integer, nop_enum_cpp> getMappings()
	{
		if (mappings == null)
		{
			synchronized (nop_enum_cpp.class)
			{
				if (mappings == null)
				{
					mappings = new java.util.HashMap<Integer, nop_enum_cpp>();
				}
			}
		}
		return mappings;
