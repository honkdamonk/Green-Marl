			...
			while (true)
			{
				...
				if (n.get_nodetype() == AST_NODE_TYPE.AST_FOREACH)
				{
					...
					else
					{
						...
						if ((iter_type == GMTYPE_T.GMTYPE_NODEITER_ALL.getValue()) || (iter_type == GMTYPE_T.GMTYPE_EDGEITER_ALL.getValue()) || (iter_type == GMTYPE_T.GMTYPE_NODEITER_SET.getValue()) || (iter_type == GMTYPE_T.GMTYPE_EDGEITER_SET.getValue()) || (iter_type == GMTYPE_T.GMTYPE_NODEITER_ORDER.getValue()) || (iter_type == GMTYPE_T.GMTYPE_EDGEITER_ORDER.getValue()))
						{
							break;
						}
						else
